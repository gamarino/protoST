...
- **Test suite:** 832 `ctest` cases (349 conformance, 42 examples, 12 CLI,
  429 unit), counted with `ctest -N` on 2026-09-15; 832/832 pass with the
  S3 fix, also with `PROTOCORE_GC_MIN_BUDGET_CELLS=4096` (one conformance
  case is an expected failure pinning D30). Before it: 830/830 with the S4
  fix, 826/826 with the D29

...
- **Test suite:** 830 `ctest` cases (349 conformance, 42 examples, 12 CLI,
  427 unit), counted with `ctest -N` on 2026-09-15; 830/830 pass with the
  S4 fix, also with `PROTOCORE_GC_MIN_BUDGET_CELLS=4096` (one conformance
  case is an expected failure pinning D30). Before it: 826/826 with the D29

...
- **Test suite:** 848 `ctest` cases (361 conformance, 42 examples, 12 CLI,
  433 unit), counted with `ctest -N` on 2026-09-24; 848/848 pass after Track S,
...
- **Open bugs:** three (D30, S3 and S15, all Medium).

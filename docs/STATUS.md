...
- **Test suite:** 826 `ctest` cases (349 conformance, 42 examples, 10 CLI,
  425 unit), counted with `ctest -N` on 2026-09-15; 826/826 pass with the
  D29 fix (one conformance case is an expected failure pinning D30). Before
  it: 807/807 with the D28 fix, 797/797 with the S6 fix, 793/793 with the

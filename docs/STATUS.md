...
- **Test suite:** 793 `ctest` cases (316 conformance, 42 examples, 10 CLI,
  425 unit), counted with `ctest -N` after reconfiguring on 2026-09-15;
  793/793 pass with the D25, D26 and D27 fixes. Before them: 786 cases.
